...
######
    ...
    V_load_2a = V_waveform_T[:,6] + V_waveform_T[:,19]
    V_load_2b = V_waveform_T[:,7] + V_waveform_T[:,21]
    V_load_2c = V_waveform_T[:,8] + V_waveform_T[:,23]
    ...
    axis[0,0].plot(time,V_waveform_T[:,3], label='l1_a')
    axis[0,0].plot(time,V_waveform_T[:,4], label='l1_b')
    axis[0,0].plot(time,V_waveform_T[:,5], label='l1_c')
    ...
    axis[1,0].plot(time,V_waveform_T[:,9], label='l2_a')
    axis[1,0].plot(time,V_waveform_T[:,10], label='l2_b')
    axis[1,0].plot(time,V_waveform_T[:,11], label='l2_c')
    ...
    axis[3,1].plot(time,L_curra, label='phase_a')
    axis[3,1].plot(time,L_currb, label='phase_b')
