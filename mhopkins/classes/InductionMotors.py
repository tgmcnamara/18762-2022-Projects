...
class InductionMotors:
    ...
    def F(self,x,x_prev, voltages):
        ...
        fx6 = x[5] - (2/3) * (math.cos(0)*voltages[0] + math.cos(-lambda_)*voltages[1] + math.cos(lambda_)*voltages[2])
        fx7 = x[6] - (2/3) * (math.sin(0)*voltages[0] + math.sin(-lambda_)*voltages[1] + math.sin(lambda_)*voltages[2])
        print("f6 and f7", fx6,fx7)
