...
def process_results(v_waveform, J_waveform, devices: Devices, settings: Settings):
    node_voltage_dict = {}
    ...
    return SimulationResults(node_voltage_dict, v_waveform, J_waveform, devices, settings)